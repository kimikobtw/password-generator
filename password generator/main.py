...
class App(CTk.CTk):
    def __init__(self):
        ...
        self.logo = CTk.CTkImage(dark_image=Image.open("image_proga.png"), light_image=Image.open("image_proga.png"), size=(460, 150))
        ...
        self.appearance_mode_option_menu = CTk.CTkOptionMenu(master=self.settings_frame, values=["Light", "Dark", "System"], command=self.change_appearance_mode_event)
